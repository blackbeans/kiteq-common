...
// //发布订阅关系
// func (self *ZKManager) PublishBindings(groupId string, bindings []*binding.Binding) error {

// 	//按topic分组
// 	groupBind := make(map[string][]*binding.Binding, 10)
// 	for _, b := range bindings {
// 		g, ok := groupBind[b.Topic]
// 		if !ok {
// 			g = make([]*binding.Binding, 0, 2)
// 		}
// 		b.GroupId = groupId
// 		g = append(g, b)
// 		groupBind[b.Topic] = g
...
// 		data, err := binding.MarshalBinds(binds)
// 		if nil != err {
...
// //获取订阅关系并添加watcher
// func (self *ZKManager) GetBindAndWatch(topic string) (map[string][]*binding.Binding, error) {
...
// 		return make(map[string][]*binding.Binding, 0), err
// 	}
...
// 	hps := make(map[string][]*binding.Binding, len(groupIds))
...
// //获取绑定对象的数据
// func (self *ZKManager) getBindData(path string) ([]*binding.Binding, error) {
...
// 	} else {
// 		binding, err := binding.UmarshalBinds(bindData)
// 		if nil != err {
