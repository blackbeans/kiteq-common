...
func filter(b *bind.Binding) bool {
...
func TestSubscribeBindings(t *testing.T) {
	...
	bindings := []*bind.Binding{bind.Bind_Direct("s-trade-001", "trade", "trade-succ-200", -1, true),
		bind.Bind_Regx("s-trade-001", "feed", "feed-geo-*", -1, true)}
